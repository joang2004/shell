#Joan Garí Parera
echo "Escriu un nombre natural i igual o més gran que 1, i et dirà el nombre de passes necessàries per completar la seqüència de Collatz";printf "Introdueix el valor: "; read num
