...
if [ $num1 -gt $num2 ]
then
    echo "a) El més gran és $num1, l'altre és $num2."

elif [ $num1 -lt $num2 ]
then
    echo "a) El més gran és $num2, l'altre és $num1."

else
    echo "a) Els dos nombres són iguals."
fi
...
then
	...
	echo "d) El primer nombre generat, que és $ran1 és igual que el segon."
fi
